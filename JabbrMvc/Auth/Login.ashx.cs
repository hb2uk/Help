...
namespace JabbR.Auth
{
    ...
    public class Login : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            var settings = NinjectWebCommon.Kernel.Get<IApplicationSettings>();
            ...
            var repository = NinjectWebCommon.Kernel.Get<IJabbrRepository>();
            var chatService = NinjectWebCommon.Kernel.Get<IChatService>();
